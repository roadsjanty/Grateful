...
import com.peacon.grateful.models.BoardSize
import com.peacon.grateful.utils.*
...
class CreateActivity : AppCompatActivity() {
    ...
    private fun handleAllImagesUploaded(gameName: String, imageUrls: MutableList<String>) {
        // TODO: upload this info to firebase
        db.collection("games").document(gameName)
            ...
            .addOnCompleteListener{gameCreationTask  ->
                ...
                AlertDialog.Builder(this)
                    .setTitle("Upload complete! Let's play the game '$gameName'")
    ...
    private fun shouldEnableSaveButton(): Boolean {
        //check if we should enable the save button not
        if(chosenImageUris.size != numImagesRequired){
            return false
        }
